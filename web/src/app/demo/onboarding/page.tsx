...
import { ChevronLeft, ChevronRight, User, BookOpen, Target, Settings, Clock, Star, Send, LogOut, Play, Wand2, RotateCcw, Sparkles } from "lucide-react";
    ...
    return (
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <div className="w-full lg:w-[38%] flex flex-col p-4 pt-6 lg:p-8 lg:border-r border-border/50">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-2">
                                <motion.button
                                    ...
                                    className="flex items-center gap-1.5 text-xs bg-primary text-primary-foreground px-3 py-1.5 rounded-md font-bold shadow-lg animate-shine"
                                >
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-between gap-3 mt-6 lg:mt-0">
                    {step > 0 && (
