...
import { apiService, MarketInsightsData } from "@/lib/api";
...
export default function MarketInsights() {
  ...
  const [insightsData, setInsightsData] = React.useState<MarketInsightsData | null>(null);
  ...
  const { your_path_fit: yourPathFit, skills, job_roles: jobRoles, companies, career_forecasts: careerForecasts } = insightsData;
          ...
          <Card className="bg-gradient-to-r from-violet-600 to-purple-600 text-white border-0">
            <CardContent className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <Button variant="secondary" onClick={() => router.push('/student/ai-companion')}>
                  Chat with AI
