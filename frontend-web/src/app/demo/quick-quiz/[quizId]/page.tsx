            ...
            <div className="flex items-center justify-center items-center min-h-screen">
                <Card className="p-8">
                    <CardContent className="text-center">
                        ...
                        <Button onClick={() => router.push('/demo/quick-quiz')}>
                            Go Back
                        </Button>
                    </CardContent>
                </Card>
                    ...
                    <Card className="overflow-hidden">
                        ...
                        <CardContent className="p-8 text-center">
                            ...
                            <div className="flex gap-4 justify-center">
                                <Button variant="outline" onClick={() => router.push('/demo/quick-quiz')}>
                                    Back to Quizzes
                                </Button>
                                <Button onClick={() => {
                                    setCurrentQuestion(0);
            ...
            <div className="h-screen w-full overflow-hidden flex items-center justify-center">
                <Card className="max-w-md w-full mx-4 my-8 relative">
                    ...
                    <Button 
                        variant="ghost" 
                        className="border"
                        onClick={() => router.push('/demo/quick-quiz')}
                    >
        ...
        <div className="min-h-screen p-4 sm:p-6 lg:p-8 relative">
            ...
            <div className="max-w-3xl mx-auto">
                <div className="flex items-center justify-between mb-6">
                    <Button variant="ghost" className="border" onClick={() => router.push('/demo/quick-quiz')}>
                        <ChevronLeft className="w-4 h-4 mr-2" />
                        Exit Quiz
                    </Button>
