                                        ...
                                        >
                                            <Card className="h-full hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer group border-violet-100 dark:border-violet-900/30">
                                                ...
                                                <CardContent>
                                                    ...
                                                    <Link href={`/demo/quick-quiz/${category.id}`} className="w-full">
                                        ...
                                        >
                                            <Card className="h-full hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer group border-violet-100 dark:border-violet-900/30">
                                                ...
                                                <CardContent>
                                                    ...
                                                    <Link href={`/demo/quick-quiz/${quiz.id}`} className="w-full">
                                                        <Button className="w-full group/btn">
                                                            Start Quiz
                                                            <ChevronRight className="w-4 h-4 ml-2 group-hover/btn:translate-x-1 transition-transform" />
                                                        </Button>
                                                    ...
                                                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            {result.status === 'in-progress' && (
                                                                <Link href={`/demo/quick-quiz/${getQuizIdByTitle(result.quizTitle)}`}>
